...
extern coap_resource_t res_humidity, res_dehumidifier;
...
PROCESS_THREAD(contiki_coap_server, ev, data) 
{
    ...
    coap_activate_resource(&res_dehumidifier, COAP_VENTILATION_PATH);
    ...
    while(1) 
    {
            ...
            (ev == PROCESS_EVENT_POLL))
        {
            ...
            else if (rack.state == COAP_STATE_NETWORK_OK)
            {
                ...
                set_json_msg_sensor_registration(message, COAP_CHUNK_SIZE, rack.rack_id, COAP_HUMIDITY_PATH);
