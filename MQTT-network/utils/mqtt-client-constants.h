...
#define MQTT_BROKER_KEEP_ALIVE                   		 30        /* Keep-alive for the MQTT connection. */


/* MQTT band (MQTT client) constants. */
#define MQTT_BAND_ID_LENGTH                           	 46  /* The maximum length of a monitor ID (an IPv6 address). */
#define MQTT_BAND_STATE_CHECK_INTERVAL                	 3   /* Interval in seconds used by the periodic timer to check the internal state. */
...
#define MQTT_BAND_TOPIC_BAND_REGISTRATION      	  		"SDCM/collector/band-registration"
#define MQTT_BAND_TOPIC_STATUS			          		"SDCM/band/%s/status"
#define MQTT_BAND_TOPIC_BAND_SAMPLE         			"SDCM/band/%s/sample"
#define MQTT_BAND_TOPIC_ALERT_STATE               		"SDCM/band/%s/alarm"	/* Subscribe. */
