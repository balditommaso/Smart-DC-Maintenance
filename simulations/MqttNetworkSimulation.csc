...
<simconf>
  ...
  <simulation>
    <title>MQTT Network Simulation</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/project/Smart-DC-Maintenance/rpl-border-router/border-router.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/project/Smart-DC-Maintenance/MQTT-network/mqtt-client.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>38.70659078131665</x>
        <y>95.99706388497958</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>38.465828280735025</x>
        <y>86.82473740197895</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>48.31430138123408</x>
        <y>101.03497900089327</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>28.853895063788727</x>
        <y>100.49274697420586</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.596668221041946 0.0 0.0 6.596668221041946 -66.52649458200202 -466.7655079161057</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
